...
#  email = "ag357@cam.ac.uk, b.woodcroft@pgrad.unimelb.edu.au"
  ...
  description = paragraphs_of("README.md",1..3)[0]
  summary     = paragraphs_of("README.md",1)[0]
...
#  p.rdoc_pattern = /(^lib\/.*\.rb$|^examples\/.*\.rb$|^README|^History|^License)/
  ...
  spec_extras = {
    ...
    :has_rdoc      => true,
    :extra_rdoc_files => ["README.md","History.txt","License.txt"] + FileList["examples/*"],
    :rdoc_options  => ["--exclude", "test/*", "--main", "README.md", "--inline-source"]
  }
